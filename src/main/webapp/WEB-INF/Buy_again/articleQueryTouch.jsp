...
<script type="text/javascript">
	...
	function load(indexpage){
		$.ajax({
			type:'post',
			url:'/querytouchbypage/' + indexpage,
			dataType:'JSON',
...
<!-- 		<h3>全部主題</h3> -->
	...
	<c:choose>
		<c:when test="${memlogin != null}">
			<div style="margin-left: 1249px;font-size: 18px;">
	...
	<br>
<!-- 	<div> -->
	<div style="text-align: left;padding-bottom: 20px;    margin-left: 432px;">
		<button onclick="location.href='/mainarticle'" class="btn btn-default" style="padding: 7px 27.8px;">全部主題</button>
		<button onclick="location.href='/toucharticle'" class="btn btn-default" style="background-color: #d3d3d3;padding: 7px 27.8px;">熱門文章</button>
		<button onclick="location.href='/vgaarticle'" class="btn btn-default" style="padding: 7px 27.8px;">顯示卡</button>
