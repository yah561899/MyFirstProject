    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center" style="margin: 0px;background-color:#ffffffb0;border:0px">
          <h2 class="text-center">撰寫您的文章</h2>
          <form action="/addarticle2" method="post" enctype="multipart/form-data">
...
<!--           	<div style="height:300px; width:300px; position:absolute; top:100; right:550px; text-align:center"> -->
              	...
              	<div id="dropZone" >
   				...
   				<div  style="display: none;">
    				...
    				<div class="xyzFileUpSel">
						<button type="button" style="    border: 1px solid #484848;" class="btn btn-outline-dark">新增圖片</button>
					</div>
            </div>
            ...
            <div class="form-group">
					...
					<textarea name="content" id="content" cols="10" rows="100"></textarea>
					<script> 
            ...
            <div class="text-center">
              	...
              	<button type="button" id="oneinsert" class="btn btn-main text-center">一鍵輸入</button>
            </div>
          </form>
        </div>
      </div>
...
$("#oneinsert").on("click",function(){
	$("#header").val('［新手開箱］RTX 3080 SUPRIM X LHR')
	
	var editor = CKEDITOR.instances['content'];
	editor.setData('大家好，今天要開箱的是微星的RTX 3080 SUPRIM X LHR，而LHR的後綴也代表這是有鎖算力的版本，先來看到盒子的外觀，整體相比上一代的旗艦，看起來多了幾分精品的感覺，以白色為主體的外盒也非常打中我的心。<br/><br/>總結<br/>這是一張不論顏值、性能表現都非常優異的卡，但目前的螢幕（1080p165hz)感覺還無法發揮這張卡的所有潛力，再加上這條中二龍魂有比公版更高的頻率，讓這張RTX 3080 SUPRIM X的表現又優於大多數的3080，之後也有考慮換上2K的螢幕，若是有任何推薦都能告訴我，或對於這次開箱有什麼想法或建議也都歡迎留言跟我說，那就先這樣嘍~拜拜~')
})
