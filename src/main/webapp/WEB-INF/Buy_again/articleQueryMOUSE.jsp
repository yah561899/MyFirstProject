...
<script type="text/javascript">
	...
	function load(indexpage){
		$.ajax({
			type:'post',
			url:'/queryMOUSEbypage/' + indexpage,
			dataType:'JSON',
...
<!-- 	<div> -->
	<div style="text-align: left;padding-bottom: 20px;    margin-left: 240px;">
		...
		<button onclick="location.href='/mousearticle'" class="btn btn-default" style="background-color: #d3d3d3;padding: 7px 27.8px;">滑鼠</button>
