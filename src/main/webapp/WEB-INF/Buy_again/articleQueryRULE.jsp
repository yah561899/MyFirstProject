		...
		$.ajax({
			...
			success: function(data){
				...
				if(data == null){
					...
					table.append("<tr id='atitle'><th>編號<th>作者</th><th>標題</th><th>編輯日期</th></tr>")
					...
					$.each(articles, function(i,n){
						...
						var tr = "<tr height='80' align='center'>" + "<td>" + n.articleId + "</td>" +
								 "<td width='100'>" + n.name + "</a></td>" +
								 "<td style='text-align:left'><a href='articlecontent?articleId=" + n.articleId +"'>" + "<b>" + "【" + sort  + "】" + n.header + "</b>" + "<br>" + "<div class='box' style='overflow:hidden;'><p class='ellipsis'>" +"&ensp;" + n.content + "</p></div>" +"</td>" + 
								 "<td width='100'>" + n.registerDate + "</td>" + 
								 "<td><button type='button' onclick='del(" + n.articleId + ")'>" + "刪除" + "</button></td>" +
								 "<td>" + msgsizes[i] + "</td>" +
								 "</tr>";
					  table.append(tr);
...
<!-- 			</div> -->
<!-- 		</div> -->
<div style="text-align:center;"><h1>版規</h1></div>
<div style="text-align:right">
<a href="querybyuserId"><button type="button" >個人小屋</button></a>
<!-- <button type="button" onclick="location.href='https://localhost:8080/insertarticle'">撰寫文章</button> -->
<a href="/insertarticle2"><button type="button">撰寫文章</button></a>
</div>
