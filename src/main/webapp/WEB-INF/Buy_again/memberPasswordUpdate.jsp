	...
	<section class="user-dashboard page-wrapper"
		...
		<div
			...
			<div class="container" style="float: top; background-color: #f7f7f7;">
				<div class="row">
					<div class="col-md-12">
						<ul class="list-inline dashboard-menu text-center" style="margin-left: -200px;">
							...
							<div class="col-md-3" style="width: 800px">
								<div class="widget product-category">
									...
									<div class="dashboard-wrapper user-dashboard">
										...
										<h4 style="font-size: 26px;text-align: center;padding: 0px;" class="widget-title">修改密碼</h4>
											<section class="user-dashboard page-wrapper"
												style="padding: 0px">
												<div>
													<div>
																	...
																	<form class="text-left clearfix"
																		...
																		<div class="media">
																			<div style="display: none">
																				...
																				<input type="file" name="picture" value="${members.img}" /> 
																				...
																				<input type="text" name="registerDate" value="${members.registerDate}" />
																			</div>
																			<div class="media-body" style="text-align: center">
																				<ul class="user-profile-list">
																					<li style="margin-bottom: 13px">
																						<label style="font-size: 16px;">帳&emsp;號&thinsp;&thinsp;:&thinsp;</label>
																						<input id="inp" type="text" value="${members.userId}" name="userId" readonly="readonly">
<%-- 																						<input style="font-size: 14px" type="text"	name="userId" readonly="readonly"	value="${members.userId}" /> --%>
																					</li>
																					<li style="margin-bottom: 13px">
																						<label style="font-size: 16px;">舊密碼&thinsp;&thinsp;:&thinsp;</label>
																						<input id="inp" type="password" value="${members.password}" readonly="readonly">
																						
<%-- 																						<input style="font-size: 14px" type="password" readonly="readonly" value="${members.password}" /></li> --%>
																					<li style="margin-bottom: 13px">
																						<label style="font-size: 16px;">新密碼&thinsp;&thinsp;:&thinsp;</label>
																						<input id="inp" type="text" value="" name="password">
																						
<!-- 																						<input style="font-size: 14px" type="text"	name="password" value="" /> -->
																					</li>
																				</ul>
																			</div>
																		</div>
