...
<script type="text/javascript">
	...
	function load(indexpage){
		$.ajax({
			type:'post',
			url:'/queryKEYBOARDbypage/' + indexpage,
			dataType:'JSON',
...
<!-- 	<div> -->
	<div style="text-align: left;padding-bottom: 20px;    margin-left: 240px;">
		...
		<button onclick="location.href='/keyboardarticle'" class="btn btn-default" style="background-color: #d3d3d3;padding: 7px 27.8px;">鍵盤</button>
